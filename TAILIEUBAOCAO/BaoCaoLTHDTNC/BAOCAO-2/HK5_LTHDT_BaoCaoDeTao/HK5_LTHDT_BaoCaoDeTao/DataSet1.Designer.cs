...
namespace HK5_LTHDT_BaoCaoDeTao {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class HocSinhDataTable : global::System.Data.TypedTableBase<HocSinhRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public HocSinhRow AddHocSinhRow(string MaHS, string TenHS, string MaLop, string GioiTinh, string SDT, System.DateTime NgaySinh, string NoiSinh, string DanToc, string DiaChi) {
...
namespace HK5_LTHDT_BaoCaoDeTao.DataSet1TableAdapters {
    ...
    public partial class HocSinhTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[HocSinh] WHERE (([MaHS] = @Original_MaHS) AND ((@IsNull_TenHS = 1 AND [TenHS] IS NULL) OR ([TenHS] = @Original_TenHS)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_NoiSinh = 1 AND [NoiSinh] IS NULL) OR ([NoiSinh] = @Original_NoiSinh)) AND ((@IsNull_DanToc = 1 AND [DanToc] IS NULL) OR ([DanToc] = @Original_DanToc)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[HocSinh] ([MaHS], [TenHS], [MaLop], [GioiTinh], [SDT], [NgaySinh], [NoiSinh], [DanToc], [DiaChi]) VALUES (@MaHS, @TenHS, @MaLop, @GioiTinh, @SDT, @NgaySinh, @NoiSinh, @DanToc, @DiaChi);
SELECT MaHS, TenHS, MaLop, GioiTinh, SDT, NgaySinh, NoiSinh, DanToc, DiaChi FROM HocSinh WHERE (MaHS = @MaHS)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[HocSinh] SET [MaHS] = @MaHS, [TenHS] = @TenHS, [MaLop] = @MaLop, [GioiTinh] = @GioiTinh, [SDT] = @SDT, [NgaySinh] = @NgaySinh, [NoiSinh] = @NoiSinh, [DanToc] = @DanToc, [DiaChi] = @DiaChi WHERE (([MaHS] = @Original_MaHS) AND ((@IsNull_TenHS = 1 AND [TenHS] IS NULL) OR ([TenHS] = @Original_TenHS)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_NoiSinh = 1 AND [NoiSinh] IS NULL) OR ([NoiSinh] = @Original_NoiSinh)) AND ((@IsNull_DanToc = 1 AND [DanToc] IS NULL) OR ([DanToc] = @Original_DanToc)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)));
SELECT MaHS, TenHS, MaLop, GioiTinh, SDT, NgaySinh, NoiSinh, DanToc, DiaChi FROM HocSinh WHERE (MaHS = @MaHS)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaHS, TenHS, MaLop, GioiTinh, SDT, NgaySinh, NoiSinh, DanToc, DiaChi FROM " +
                "dbo.HocSinh";
        ...
        public virtual int Delete(string Original_MaHS, string Original_TenHS, string Original_MaLop, string Original_GioiTinh, string Original_SDT, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_NoiSinh, string Original_DanToc, string Original_DiaChi) {
        ...
        public virtual int Insert(string MaHS, string TenHS, string MaLop, string GioiTinh, string SDT, global::System.Nullable<global::System.DateTime> NgaySinh, string NoiSinh, string DanToc, string DiaChi) {
            if ((MaHS == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_TenHS == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_TenHS));
            }
            if ((Original_MaLop == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_DanToc, 
                    string Original_DiaChi) {
            return this.Update(Original_MaHS, TenHS, MaLop, GioiTinh, SDT, NgaySinh, NoiSinh, DanToc, DiaChi, Original_MaHS, Original_TenHS, Original_MaLop, Original_GioiTinh, Original_SDT, Original_NgaySinh, Original_NoiSinh, Original_DanToc, Original_DiaChi);
        }
    }
